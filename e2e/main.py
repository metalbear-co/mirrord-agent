    ...
    return client.V1Pod(
        ...
        spec=client.V1PodSpec(
            ...
            volumes=[client.V1Volume(
                name="containerd",
                host_path=client.V1HostPathVolumeSource(path='/run/containerd/containerd.sock')
            )],
            containers=[
                client.V1Container(
                    name="mirrord-agent",
...
def main():
    ...
    container_id = pods[0].status.container_statuses[0].container_id.replace('containerd://', "")
